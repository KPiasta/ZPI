...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
            ...
            <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" OnMenuItemClick="Menu1_MenuItemClick">
                <staticmenuitemstyle  HorizontalPadding="10px" BackColor="#464764" BorderWidth="2px" BorderColor="Black" BorderStyle="Ridge"/>
                <staticselectedstyle HorizontalPadding="10px" BackColor="#3f4b89" BorderWidth="2px" BorderColor="Black" BorderStyle="Ridge"/>
                <Items>
        ...
        <div style="background-color:#464764;height:100%">
